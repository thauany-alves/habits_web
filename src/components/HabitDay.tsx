...
export function HabitDay ({ defaultCompleted = 0, amount = 0, date }: HabitDayProps) {
  ...
  return(
    <Popover.Root>
      ...
      />
      <Popover.Portal className='border-none'>
        <Popover.Content className='min-w-[320] p-6 rounded-2xl bg-zinc-900 flex flex-col'>
          <span className='font-semibold to-zinc-400'>{dayOfWeek}</span>
